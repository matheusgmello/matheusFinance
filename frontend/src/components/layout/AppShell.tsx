  ...
  return (
    <div className="flex h-screen bg-bg-body overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden min-w-0">
        <div className="flex items-center gap-3 px-4 py-3 bg-bg-card border-b border-c-border flex-shrink-0">
          <button
            onClick={() => setSidebarOpen(true)}
            className="md:hidden text-c-muted hover:text-c-primary transition-colors"
          >
            <Menu size={22} />
          </button>
          <span className="md:hidden text-accent-500 font-bold text-base tracking-tight">
